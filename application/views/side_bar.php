    ...
    <div class="widget-area">
        <aside class="widget widget-profile">
            <div class="profile-photo">
                <img src="<?php img_dir() .'uploads/rs-photo-v2.jpg'; ?>" alt="Robert Smith"/>
            </div>
        ...
        <aside class="widget widget-popuplar-posts">
            ...
            <ul>
                <li>
                    <div class="post-media"><a href=""><img src="<?php img_dir() .'uploads/thumb-78x56-1.jpg'; ?>" alt=""/></a></div>
                ...
                <li>
                    <div class="post-media"><a href=""><img src="<?php img_dir() .'uploads/thumb-78x56-2.jpg'; ?>" alt=""/></a></div>
                    <h3 class="post-title"><a href="">Standard Post Format With Featured Image</a></h3>

                    <div class="post-info"><a href=""><i class="rsicon rsicon-comments"></i>56 comments</a></div>
                </li>
                <li>
                    <div class="post-media"><a href=""><img src="<?php img_dir() .'uploads/thumb-78x56-3.jpg'; ?>" alt=""/></a></div>
                    <h3 class="post-title"><a href="">Standard Post Format With Featured Image</a></h3>
