<div class="wrapper">
    <header class="header">
        <div class="head-bg" style="background-image: url(<?php echo img_dir() .'uploads/rs-cover.jpg'; ?>)"></div>
                ...
                <div class="row">
                    <div class="col-sm-3 col-xs-6">
                        <a class="logo" href="index.html"><span>RS</span>card</a>
                         <a class="head-logo" href=""><img src="<?php echo img_dir() .'rs-logo.png'; ?>" alt="RScard"/></a>
                    </div>
        ...
        <div class="container">
                ...
                <div class="animate-up">
                    <div class="section-box">
                        <div class="profile">
                            <div class="row">
                                <div class="col-xs-5">
                                    <div class="profile-photo"><img src="<?php echo img_dir() .'uploads/rs-photo-v1.jpg'; ?>" alt="Robert Smith"/></div>
                                </div>
                                <div class="col-xs-7">
                    ...
                    <div class="section-txt-btn">
                        <p><a class="btn btn-lg btn-border ripple" target="_blank"
                              href="http://dev.novembit.com/rs_card/wp-content/uploads/2015/11/test-1.pdf">Download
                                Resume</a></p>
                        ...
                        <p>Hello! I'm Robert Smith. Senior Web Developer specializing in front end development.
                            ...
                            including JavaScript, SQL, and C. Stng background in project management and customer
                            relations.</p>
                    </div>
                </div>
            </section>
                ...
                <div class="animate-up">
                    ...
                    <div class="grid">
                        ...
                        <div class="grid-item size22 photography">
                            <div class="grid-box">
                                <figure class="portfolio-figure">
                                    <img src="<?php echo img_dir() .'uploads/portfolio/portfolio-thumb-05-610x600.jpg'; ?>" alt=""/>
                                ...
                                <div id="portfolio1-inline1" class="fancybox-inline-box">
                                    <div class="inline-embed" data-embed-type="image"
                                         data-embed-url="<?php echo img_dir() .'uploads/portfolio/portfolio-thumb-05-large.jpg'; ?>"></div>
                                    <div class="inline-cont">
                                        <h2 class="inline-title">Street photography is photography that features the
                                            chance
                                            encounters and random accidents within public places.</h2>

                                        <div class="inline-text">
                                            <p>Street photography does not necessitate the presence of a street or even
                                                the urban
                                                environment. Though people usually feature directly, street photography
                                                might be
                                                absentr of people and can be an object or environment where the image
                                                projects a
                                ...
                                <div id="portfolio1-inline2" class="fancybox-inline-box">
                                    <div class="inline-embed" data-embed-type="image"
                                         data-embed-url="<?php echo img_dir() .'uploads/portfolio/portfolio-thumb-01-large.jpg'; ?>"></div>
                                    <div class="inline-cont">
                                        <div class="inline-text">
                                            <h2 class="inline-title">Framing and timing</h2>

                                            <p>Framing and timing can be key aspects of the craft with the aim of some
                                                street
                                                photography being to create images at a decisive or poignant moment.
                                                Street
                                                photography can focus on emotions displayed, thereby also recording
                                                people's history
                                ...
                                <div id="portfolio1-inline3" class="fancybox-inline-box">
                                    ...
                                    <div class="inline-cont">
                                        <div class="inline-text">
                                            <h2 class="inline-title">A Look Into Documenting Street Fashion
                                                Photography</h2>

                                            <p>HB Nam is an internationally known street fashion photographer. In this
                                                Leica Camera
                                                Portrait, Nam explains how he started in photography and what
                                                photography means to
                                                him. For Nam, it's about documenting what's around him and the
                                                concentration
                        ...
                        <div class="grid-item size11 bridge">
                            <div class="grid-box">
                                <figure class="portfolio-figure">
                                    <img src="<?php echo img_dir() .'uploads/portfolio/portfolio-thumb-11-289x281.jpg'; ?>" alt=""/>
                                    <figcaption class="portfolio-caption">
                                        <div class="portfolio-caption-inner">
                                ...
                                <div id="portfolio2-inline1" class="fancybox-inline-box">
                                    <div class="inline-cont">
                                        ...
                                        <div class="inline-text">
                                            <p>Suspension bridges in their simplest form were originally made from rope
                                                and wood.
                                                Modern suspension bridges use a box section roadway supported by high
                                                tensile
                                                strength cables.
                                                In the early nineteenth century, suspension bridges used iron chains for
                                                cables. The
                                                high tensile cables used in most modern suspension
                                                bridges were introduced in the late nineteenth century.<br/>
                                                Today, the cables are made of thousands of individual steel wires bound
                                                tightly
                                                together. Steel, which is very strong under tension, is
                                                an ideal material for cables; a single steel wire, only 0.1 inch thick,
                                                can support
                                                over half a ton without breaking.</p>

                                            <p>Light, and strong, suspension bridges can span distances from 2,000 to
                                                7,000 feet far
                                                longer than any other kind of bridge. They are
                                                ideal for covering busy waterways.</p>

                                            <p>With any bridge project the choice of materials and form usually comes
                                                down to cost.
                                                Suspension bridges tend to be the most expensive to build. A suspension
                                                bridge
                                                suspends the roadway from huge main cables, which extend
                                                from one end of the bridge to the other. These cables rest on top of
                                                high towers and
                                                have to be securely anchored into the bank at either
                                                end of the bridge. The towers enable the main cables to be draped over
                                                long
                                                distances. Most of the weight or load of the bridge is
                                                transferred by the cables to the anchorage systems. These are imbedded
                                                in either
                                                solid rock or huge concrete blocks. Inside the anchorages,
                                                the cables are spread over a large area to evenly distribute the load
                                                and to prevent
                                                the cables from breaking free.</p>

                                            <p>The Arthashastra of Kautilya mentions the construction of dams and
                                                bridges.A Mauryan
                                                bridge near Girnar was surveyed by James Princep.
                                                The bridge was swept away during a flood, and later repaired by
                                                Puspagupta, the
                                                chief architect of emperor Chandragupta I. The bridge
                                                also fell under the care of the Yavana Tushaspa, and the Satrap Rudra
                                                Daman. The use
                                                of stronger bridges using plaited bamboo and iron
                                                chain was visible in India by about the 4th century. A number of
                                                bridges, both for
                        ...
                        <div class="grid-item size11 nature photography">
                            <div class="grid-box">
                                <figure class="portfolio-figure">
                                    <img src="<?php echo img_dir() .'uploads/portfolio/portfolio-thumb-08-289x281.jpg'; ?>" alt=""/>
                                    <figcaption class="portfolio-caption">
                                        <div class="portfolio-caption-inner">
                                ...
                                <div id="portfolio3-inline1" class="fancybox-inline-box">
                                    <div class="inline-embed" data-embed-type="image"
                                         data-embed-url="<?php echo img_dir() .'uploads/portfolio/portfolio-thumb-08-large.jpg'; ?>"></div>
                                </div>

                                <div id="portfolio3-inline2" class="fancybox-inline-box">
                                    <div class="inline-embed" data-embed-type="image"
                                         data-embed-url="<?php echo img_dir() .'uploads/portfolio/portfolio-thumb-04-large.jpg'; ?>"></div>
                                </div>

                                <div id="portfolio3-inline3" class="fancybox-inline-box">
                                    <div class="inline-embed" data-embed-type="image"
                                         data-embed-url="<?php echo img_dir() .'uploads/portfolio/portfolio-thumb-02-large.jpg'; ?>"></div>
                                </div>
                                <!-- End: Portfolio Inline Boxes -->
                            </div>
                        </div>
                        ...
                        <div class="timeline-inner clearfix">
                            <div class="timeline-box timeline-box-left">
                                ...
                                <div class="timeline-box-inner animate-right">
                                    ...
                                    <p>Worked as part of a multi-disciplinary team, carrying out ad-hoc tasks as
                                        requested by the IT
                                        Manager. Had a specific brief to ensure the websites build for customer’s
                                        precisely matched
                            ...
                            <div class="timeline-box timeline-box-right">
                                ...
                                <div class="timeline-box-inner animate-left">
                                    ...
                                    <p>I was responsible for working on a range of projects, designing appealing
                                        websites and
                                        interacting on a daily basis with graphic designers, back-end developers and
                                        marketers.</p>
                                </div>
                            </div>
                            ...
                            <div class="timeline-box timeline-box-left">
                                ...
                                <div class="timeline-box-inner animate-right">
                                    ...
                                    <p>Rebuilt and enhanced existing ASP B2C site with ASP.NET 2.0 Framework and tools.
                                        Technology
                                        consists of ASP.NET 2.0 (C#), IIS, Microsoft SQL Server 2005, Stored Procedures
                                        & PayPal
                            ...
                            <div class="timeline-box timeline-box-right">
                                ...
                                <div class="timeline-box-inner animate-left">
                                    ...
                                    <p>Developed, managed, operated and promoted an Internet business.Handled customer
                                        support
                            ...
                            <div class="timeline-box timeline-box-left">
                                ...
                                <div class="timeline-box-inner animate-right">
                                    ...
                                    <p>This was beginning of my career. Developed, managed, operated and promoted an
                                        Internet
                            ...
                            <div class="timeline-box timeline-box-right">
                                ...
                                <div class="timeline-box-inner animate-left">
                                    ...
                                    <p>Driving from point A to point B and if necessary to point C and sometimes even to
                                        point R and
                                        point S. I was known as experienced driver. Once my passenger who was a web
                                        developer told
                                        me about his job and I have made my decision at that moment to became a
                                        developer.</p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="animate-up">
                    ...
                    <div class="clients-carousel">
                        <div class="client-logo">
                            <a href="http://market.envato.com" target="_blank"><img
                                    src="<?php echo img_dir() .'uploads/logos/logo-envato.png"'; ?>
                                    title="envato" alt="envato"/></a>
                        </div>

                        <div class="client-logo">
                            <img src="<?php echo img_dir() .'uploads/logos/logo-angularjs.png'; ?>" title="angular js" alt="angular js"/>
                        </div>

                        <div class="client-logo">
                            <a href="https://www.omniref.com/ruby/gems/teaspoon/0.7.9" target="_blank"><img
                                    src="<?php echo img_dir() .'uploads/logos/logo-teaspoon.png' ;?>" title="teaspoon" alt="teaspoon"/></a>
                        </div>

                        <div class="client-logo">
                            <a href="https://wordpress.com" target="_blank"><img
                                    src="<?php echo img_dir() .'uploads/logos/logo-wordpress.png'; ?>"
                                    title="wordpress" alt="wordpress"/></a>
                        </div>

                        <div class="client-logo">
                            <a href="https://evernote.com" target="_blank"><img
                                    src="<?php echo img_dir() .'uploads/logos/logo-evernote.png'; ?>"
                                    title="evernote" alt="evernote"/></a>
                        </div>

                        <div class="client-logo">
                            <a href="http://compass-style.org" target="_blank"><img
                                    src="<?php echo img_dir() .'uploads/logos/logo-compass.png'; ?>"
                                    title="compass" alt="compass"/></a>
                        </div>

                        <div class="client-logo">
                            <a href="http://getbootstrap.com" target="_blank"><img
                                    src="<?php echo img_dir() .'uploads/logos/logo-bootstrap.png'; ?>"
                                    title="bootstrap" alt="bootstrap"/></a>
                        </div>

                        <div class="client-logo">
                            <a href="http://jasmine.github.io" target="_blank"><img
                                    src="<?php echo img_dir() .'uploads/logos/logo-jasmine.png'; ?>"
                                    title="jasmine" alt="jasmine"/></a>
                        </div>

                        <div class="client-logo">
                            <a href="https://jquery.com" target="_blank">
                                <img src="<?php echo img_dir() .'uploads/logos/logo-jquery.png'; ?>" title="jquery" alt="jquery"/>
                            </a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="section-box">
                        <ul class="ref-slider">
                            <li>
                                <div class="ref-box">
                                    <div class="person-speech">
                                        <p>I confirm that I have dealt with New Company Ltd since 1998. Their work has
                                            been a major
                                            factor in our
                                            website's success, helping it to become one of the most visited resources of
                                            its kind on
                                            the Internet.</p>
                                    </div>
                                    <div class="person-info clearfix">
                                        <img class="person-img" src="<?php echo img_dir() .'uploads/rs-avatar-60x60.jpg'; ?>" alt="Headshot">
                            ...
                            <li>
                                <div class="ref-box">
                                    <div class="person-speech">
                                        <p>I confirm that New Company Ltd has been a customer of ours since 1998, during
                                            which time
                            ...
                            <li>
                                <div class="ref-box">
                                    <div class="person-speech">
                                        <p>I have known Robert Smith for 10 years as web developer. I can confirm that
                                            he is a man
                            ...
                            <article class="post-box">
                                <div class="post-media">
                                    <div class="post-image">
                                        <a href="single.html"><img src="<?php echo img_dir() .'uploads/thumb-449x286-1.jpg'; ?>" alt=""> </a>
                                    </div>
                                </div>
                                ...
                                <div class="post-media">
                                    <div class="post-image">
                                        <a href="single-vimeo.html">
                                            <img src="<?php echo img_dir() .'uploads/thumb-449x286-5.jpg'; ?>" alt="">
            ...
            <section id="text-section" class="section section-text">
                <div class="animate-up animated">
                    ...
                    <div class="section-box">
                        <p>Hello! I’m Robert Smith and this is custom editor section. You can add here any text or
                            "Strikethrough"
                            text and even you can add bulleted or numbered text and even you will be able to add
                            blockquot text. You
                            can align this text to left/right/center.

                            One of the most interesting options is to divide this section to "One half" "One Third" and
                            "One
                            Fourth".

                            You can use this for Honors or Achievments or Awards sections. You can insert images and
                            photos right in
                            this editor!</p>
                    </div>
                </div>
            ...
            <section id="interests" class="section section-interests">
                <div class="animate-up">
                    ...
                    <div class="section-box">
                        <p>I have a keen interest in photography. I was vice-president of the photography club during my
                            time at
                            university,
                            and during this period I organised a number of very successful exhibitions and events both
                            on and off
                            campus.
            ...
            <section id="calendar" class="section section-calendar">
                <div class="animate-up">
                    ...
                    <div id="busyCalendar" class="calendar-busy">
                        <div class="calendar-today" style="background-image: url(<?php echo img_dir() .'uploads/rs-calendar-cover.jpg'; ?>)">
                        ...
                        <div class="calendar-cont">
                            <div class="calendar-header">
                                <div class="calendar-nav">
                                    ...
                                    <a class="calendar-prev ripple-centered" title="Prev"><i
                                            class="rsicon rsicon-chevron_left"></i></a>
    ...
    <footer class="footer">
        <div class="footer-social">
            <ul class="social">
                ...
                <li><a class="ripple-centered" href="" target="_blank"><i class="rsicon rsicon-google-plus"></i></a>
                </li>
